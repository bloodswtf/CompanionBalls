...
public class RobotConnector extends Thread implements BluetoothDiscoveryListener, Runnable, RobotListener
{
	// Internal storage
	...
	public ArrayList<Robot> getRobotArray()	{
		return robots;
	}

	//TODO: finnish this so the thread can be stopped
	void stopThread()
	{
		if( bt != null )
			bt.cancelDiscovery();
	...
	/**
	 * Here under run there are two options for connecting a sphero, you either connect it by hard coding the address or by doing a automatic search 
	 */
	@Override
	public void run()
	{
